...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-black/50">
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-6 text-base font-semibold">
          ...
          <Link href="/services" className="text-white hover:text-green-400">Services</Link>
      ...
      >
        ...
        <nav className="flex flex-col items-center justify-center py-8 space-y-6 text-white">
          <Link href="/about" onClick={() => setMobileOpen(false)} className="text-xl font-semibold hover:text-green-400">
            About
          </Link>
          <Link href="/services" onClick={() => setMobileOpen(false)} className="text-xl font-semibold hover:text-green-400">
            Services
          </Link>
          <Link href="/contact" onClick={() => setMobileOpen(false)} className="text-xl font-semibold hover:text-green-400">
            Contact
          </Link>
          <Link
            href="/book"
